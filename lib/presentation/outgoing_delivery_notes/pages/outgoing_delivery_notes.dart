...
class OutgoingDeliveryNotesPage extends StatefulWidget {
  const OutgoingDeliveryNotesPage({super.key});

  @override
  State<OutgoingDeliveryNotesPage> createState() =>
      _OutgoingDeliveryNotesPageState();
}

class _OutgoingDeliveryNotesPageState extends State<OutgoingDeliveryNotesPage> {
  @override
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: Center(child: Text("giden irsaliye içerik")),
